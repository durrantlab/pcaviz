...
Clazz_load (["J.popup.GenericSwingPopup", "java.util.Properties", "JU.Lst"], "J.popup.JmolGenericPopup", ["java.lang.Boolean", "java.util.Arrays", "$.Hashtable", "JU.PT", "J.i18n.GT", "JM.Group", "J.popup.MainPopupResourceBundle", "JU.Elements", "JV.Viewer"], function () {
...
this.vwr = vwr;
this.initSwing (title, bundle, vwr.html5Applet, JV.Viewer.isJS, vwr.getBooleanProperty ("_signedApplet"), JV.Viewer.isWebGL);
...
if (JV.Viewer.isJS || this.nFrankList < 2) return;
...
this.frankList[this.nFrankList++] =  Clazz_newArray (-1, [menu.getParent (), menu, Integer.$valueOf (JV.Viewer.isJS ? 0 : this.menuGetListPosition (menu))]);
