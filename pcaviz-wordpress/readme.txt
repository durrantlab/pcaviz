...
3. You can also control the molecular styles. The WordPress plugin uses [3DMol.js](https://3dmol.csb.pitt.edu) to render molecules. Passing the plugin a [3DMol.js AtomStyleSpec](https://3dmol.csb.pitt.edu/doc/types.html#AtomStyleSpec) JSON string changes the way the molecules are displayed. `[pcaviz visStyle='{"cartoon": {"style": "trace", "color": "grey", "opacity": 0.75}}']`
